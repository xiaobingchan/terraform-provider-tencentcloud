...
func TestAccTencentCloudInstanceWithNetwork(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTencentCloudInstanceWithNetwork("false", 0),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID(id),
					testAccCheckTencentCloudInstanceExists(id),
					resource.TestCheckResourceAttr(id, "instance_status", "RUNNING"),
			...
			{
				Config: testAccTencentCloudInstanceWithNetwork("true", 1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTencentCloudDataSourceID(id),
					testAccCheckTencentCloudInstanceExists(id),
					resource.TestCheckResourceAttr(id, "instance_status", "RUNNING"),
...
func testAccTencentCloudInstanceWithNetwork(hasPublicIp string, bandwidth int) string {
	return fmt.Sprintf(
